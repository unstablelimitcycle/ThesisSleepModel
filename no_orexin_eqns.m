function dx = no_orexin_eqns(t,x)

%%% For decreased Human orexin levels, deplete levels by 80% - multiply
%%% orexin contributions by 0.2
...
%OX - W
dx(3) = 0.02*c(8)*x(6) + (0.02*c(9) - c(10))*x(7) + (0.02*c(11) - c(12))*x(3) + 0.02*c(13)*x(10) - c(14)*x(8) - c(15)*x(11) - c(16)*x(2);
%H - W
